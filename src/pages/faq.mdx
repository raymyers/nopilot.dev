...
**A:** Try the [Nopilot Discord](https://discord.gg/k3hzFm5ykA), `#questions` channel.
...
**ReAct**: Short for [Reason Act](https://www.promptingguide.ai/techniques/react), this prompting technique enables LLM problem solving with tool-use (not to be confused with the React Javascript framework). Several coding agents are based on it, including SWE-agent and CodeAct.
